  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        {[
          { title: "Our Mission", desc: "To spread awareness and promote our business by providing quality motorcycles and exceptional customer service." },
          { title: "Quality Bikes", desc: "Every bike in our inventory is carefully selected and inspected. We ensure you get the best value for your money." },
          { title: "Customer First", desc: "Your satisfaction is our priority. We believe in honest deals, transparent pricing, and building long-term relationships." },
        ].map((card, i) => (
          <ScrollReveal key={i} delay={i * 100}>
            <div className="bg-white dark:bg-dark-surface-alt rounded-xl border border-border dark:border-dark-border p-6 h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Contact info */}
        <ScrollReveal>
          <div className="bg-white dark:bg-dark-surface-alt rounded-xl border border-border dark:border-dark-border p-8 h-full">
        ...
        <ScrollReveal delay={150}>
          <div className="bg-white dark:bg-dark-surface-alt rounded-xl border border-border dark:border-dark-border overflow-hidden h-full">
            <iframe
